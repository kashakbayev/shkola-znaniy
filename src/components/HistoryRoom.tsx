...
const FIGURES: HistoricalFigure[] = [
  ...
  },
  {
    ...
    period: 'XVIII ғасыр',
    image: '/history/kabanbay-batyr.jpg',
  ...
  },
  {
    ...
    image: '/history/tole-bi.jpg',
    options: ['Әйтеке би', 'Қазыбек би', 'Төле би', 'Бұқар жырау'],
    correct: 2,
    reward: 5,
  },
];
...
const HistoryRoom: React.FC = () => {
  ...
  const next = () => {
    setFigureIndex(Math.min(figureIndex + 1, FIGURES.length - 1));
    setSelected(null);
    setFeedback(null);
  };

  const prev = () => {
    setFigureIndex(Math.max(figureIndex - 1, 0));
    setSelected(null);
    setFeedback(null);
  };
          ...
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs" style={{ color: 'hsl(30 15% 50%)' }}>
                Тапсырма {figureIndex + 1}/{FIGURES.length}
              </span>
